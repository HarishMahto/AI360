    ...
    <Box className="page-enter" sx={{ p: 0, width: '100%', bgcolor: '#F4F6FA', minHeight: '100vh' }}>
      <Box sx={{ px: { xs: 1, md: 1.5 }, pt: { xs: 1, md: 1.5 }, width: '100%' }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '4fr 8fr' }, gap: 2, mb: 3, width: '100%' }}>
          <Box sx={{ width: '100%' }}>
            <Card sx={{ ...cardSx, width: '100%', borderTop: '3px solid #1F5AA6', height: '100%' }}>
        ...
        <Box sx={{ width: '100%', mb: 3 }}>
          <Card sx={{ ...cardSx, width: '100%' }}>
            <CardContent sx={{ p: 3, '&:last-child': { pb: 2.5 } }}>
              ...
              <TableContainer sx={{ minHeight: 400, borderRadius: '12px', border: '1px solid rgba(31,90,166,0.09)', boxShadow: 'none', width: '100%' }}>
                <Table sx={{ width: '100%' }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: '#F0F4F8' }}>
                      <TableCell sx={{ fontSize: '0.67rem', fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase', color: '#4B5563', py: 1.5, px: 3 }}>Department</TableCell>
